...
+!add_available_roles
	<-	+availableRole(1,explorer,map_explorer_helper,m_help_explore_map,"teamSch","marsGroupBoard");
		...
		+availableRole(5,explorer,map_explorer_helper,m_help_explore_map,"teamSch","marsGroupBoard");
		+availableRole(6,explorer,map_explorer_helper,m_help_explore_map,"teamSch","marsGroupBoard");
		...
		+availableRole(18,sentinel,sentinel,m_sabotage,"attackSch","attackGroupBoard");
